...
{
    public function test_when_cache_does_not_contain_key_the_database_is_used()
    {
    ...
    public function test_when_cache_and_database_values_dont_exist_the_original_language_file_is_used()
    {
        $this->assertEquals('description', $this->translator->get('about.content', [], 'fr')); // Default is true
    }

    public function test_when_cache_contains_null_the_database_is_used()
    {
    ...
    public function test_when_database_contains_null_the_translation_file_is_used()
    {
    ...
    public function test_when_database_contains_an_intentional_empty_string_the_database_is_still_used()
    {
        app(AddDatabaseLine::class)->handle(Line::fromRaw('about.hello', [
            'en' => '',
        ]));
    ...
    public function test_it_uses_original_source_for_excluded_files()
    {
